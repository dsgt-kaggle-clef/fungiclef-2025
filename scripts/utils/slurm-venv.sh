#!/usr/bin/env bash
# usage: source scripts/utils/slurm-venv.sh [venv_root]
...
# Optional argument to specify the virtual environment root (default: ~/scratch/fungiclef)
VENV_PARENT_ROOT="${1:-$HOME/scratch/fungiclef}"
