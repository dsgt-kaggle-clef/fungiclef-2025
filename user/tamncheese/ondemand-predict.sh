...
model_name="plantclef-classifier-linear-weightSampler-multiObjective-epoch=07-val_loss=20.64.ckpt"
embedding_dir="plantclef" # plantclef or dinov2
csv_filename="weightSampler_plantclef_linear_multiObjective.csv" # prediction filename
