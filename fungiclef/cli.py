...
from fungiclef.multimodalmultiobjective import app as multimodalmultiobjective_app
...
app.add_typer(
    multimodalmultiobjective_app,
    name="multimodalmultiobjective",
    help="Train and evaluate multimodal + multiobjective models.",
)
